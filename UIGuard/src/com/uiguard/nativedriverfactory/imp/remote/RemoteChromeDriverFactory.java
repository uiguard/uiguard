...
public class RemoteChromeDriverFactory extends RemoteDriverFactory implements INativeDriverFactory {

	@Override
	public RemoteWebDriver getNativeWebDriver() throws UiGuardException {
		return getNativeWebDriverByCapabilities(DesiredCapabilities.chrome());
	}
