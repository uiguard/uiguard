...
public class RemoteInternetExplorerDriverFactory extends RemoteDriverFactory implements INativeDriverFactory {

	@Override
	public RemoteWebDriver getNativeWebDriver() throws UiGuardException {
		return getNativeWebDriverByCapabilities(DesiredCapabilities.internetExplorer());		
	}
